...
def evaluate_model(list_rast_gt, model, data_fusion=True):
        ...
        for year2 in list_rast_gt:
            ...
            if year1 != year2:
                ...
                for ind in range(len(list_rast_gt[year2])):
                    ...
                    cmap, dccode, code1, code2 = fun.change_detection(rast1, rast2, model, visualization=False, data_fusion=data_fusion)
